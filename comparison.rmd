...
Here we define our method that compares normal testing with 10-fold cross validation and our metrics calculation method.
...
We first output the results of testing and cross-validation for the C4.5 classifier.
...
Here we repeat the same procedure for each of the following classifiers:
